...
= 5.8013 =
* Fixes 2 security issues reported byh WordFence, update strongly encouraged.
...
= 5.785 =
* Fixed a XSS on the add issue page.

= 5.78 =
* Fixed a XSS on the settings page and order export issue to avoid unauthorized exports. Issues reported by patchstack.
...
= 5.560 =
* Added external gateways support. Stripe now included for direct credit card payments in Business edition of the plugin, you can find it here: [Ebook Store Pricing](https://www.shopfiles.com/index.php/products/wordpress-ebook-store)
