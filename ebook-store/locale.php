...
$formats_locale['pdf'] = __('PDF');
$formats_locale['mobi'] = __('Mobi (Kindle)');
$formats_locale['epub'] = __('ePub (Nook)');
$formats_locale['txt'] = __('Txt');
$formats_locale['zip'] = __('ZIP');
$formats_locale['mp3'] = __('MP3');
$formats_locale['mp4'] = __('MP4');
...
if (get_option('ebook_store_locale') != 0) {
	$locale = $l[get_option('ebook_store_locale','en')];
} else {
	$locale = $l['default'];
}
